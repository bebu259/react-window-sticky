  ...
  function (_PureComponent) {
    ...
    _proto.render = function render() {
      var _this$props4 = this.props,
          ...
          stickyClassNamePrefix = _this$props4.stickyClassNamePrefix,
          stickyElementType = _this$props4.stickyElementType,
          stickyFirstColumn = _this$props4.stickyFirstColumn,
          stickyFirstRow = _this$props4.stickyFirstRow,
      ...
      var items = [];
      var stickyRowItems = [];
      var stickyColumnItems = [];
      var minRowIndex = stickyFirstRow ? 1 : 0;
      var minColumnIndex = stickyFirstColumn ? 1 : 0;

      if (columnCount > 0 && rowCount) {
        for (var _rowIndex = Math.max(minRowIndex, rowStartIndex); _rowIndex <= rowStopIndex; _rowIndex++) {
          for (var _columnIndex = Math.max(minColumnIndex, columnStartIndex); _columnIndex <= columnStopIndex; _columnIndex++) {
        ...
        if (stickyFirstColumn) {
          for (var _rowIndex2 = Math.max(minRowIndex, rowStartIndex); _rowIndex2 <= rowStopIndex; _rowIndex2++) {
            stickyColumnItems.push(react.createElement(children, {
              columnIndex: 0,
              data: itemData,
              isScrolling: useIsScrolling ? isScrolling : undefined,
              key: itemKey({
              ...
              rowIndex: _rowIndex2,
              style: this._getItemStyle(_rowIndex2, 0)
            }));
          }
        }

        if (stickyFirstRow) {
          for (var _columnIndex2 = Math.max(minColumnIndex, columnStartIndex); _columnIndex2 <= columnStopIndex; _columnIndex2++) {
            stickyRowItems.push(react.createElement(children, {
              ...
              rowIndex: 0,
              style: this._getItemStyle(0, _columnIndex2)
            }));
          }
        }
      ...
      if (stickyColumnItems.length) {
        ...
        items.unshift(react.createElement(stickyElementType || 'div', {
          children: stickyColumnItems,
          key: 'sticky-first-column',
          className: stickyClassNamePrefix && stickyClassNamePrefix + "-column",
          style: {
      ...
      if (stickyRowItems.length) {
        var _topLeftStyle = this._getItemStyle(0, 0);
      ...
      if (stickyRowItems.length && stickyColumnItems.length) {
        var _topLeftStyle2 = this._getItemStyle(0, 0);

        return [react.createElement(stickyElementType || 'div', {
          ...
          key: 'sticky-corner',
          className: stickyClassNamePrefix && stickyClassNamePrefix + "-corner",
          style: {
            height: _topLeftStyle2.height,
            width: _topLeftStyle2.width,
            position: 'fixed',
            zIndex: 2
          }
        }), outerElement];
